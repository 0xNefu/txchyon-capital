...
description: "Step-by-step guide to the Aster funding rate arb that's printing 28.1% APR right now. No personal trades, just the mechanics â€” plus your referral link for bonus rewards and airdrop points."
date: 2025-11-24
...
Aster's perpetuals market is currently in heavy contango, with longs paying shorts **+0.076% every 8 hours** â€” that's **28.1% annualized** for pure funding collection.
...
In this guide, we'll break down the exact mechanics, step-by-step execution, and why this setup works in November 2025. Anyone with $1kâ€“$1M can copy it in under 5 minutes.
...
- Rebalance delta every 48 hours â†’ net flat exposure, pure funding yield
...
This isn't theoretical â€” it's live on-chain. Cumulative funding paid to shorts on Aster since October: **$28.4M**.
...
- Deposit USDT or SOL (start with $1kâ€“$10k for testing)

### 2. Open the Short Perp Position
- Navigate to Perps â†’ AST/USDT pair
- Switch to **Pro Mode** (for precise leverage)
- Short AST/USDT with **5â€“10x leverage** (e.g., $10k margin for $50kâ€“$100k notional)
...
- Buy equal notional AST spot (e.g., $50kâ€“$100k worth)
- Choose the tightest bin for minimal impermanent loss
- This hedges your perp short â†’ net delta ~0.03 (essentially flat)

### 4. Monitor & Rebalance
- Check delta every 24â€“48 hours on Aster dashboard
- If delta > 0.1, rebalance by adjusting spot or perp size
- Funding payments auto-accrue to your wallet every 8 hours
- Weekly PnL: Expect **+0.5â€“0.8%** from funding alone

### 5. Exit When Funding Turns Negative
- Monitor 8h rate â€” if it flips to -0.05% or lower, unwind
- Close perp short, sell spot long â†’ pocket the yield
- Current horizon: 3â€“6 months (until Solana rally flips the funding)

## Why This Works in November 2025 (On-Chain Data)
Aster's perp market is in **extreme contango**:
- **Funding skew**: +0.076% / 8h â†’ longs over-leveraged, shorts get paid
- **OI skew**: 72% long / 28% short â†’ structural imbalance
- **Volume skew**: 68% retail longs â†’ whales quietly shorting for funding

Compare to competitors:
- Drift: +0.019% funding (weaker arb)
- Hyperliquid: -0.008% funding (shorts paying longs â€” avoid)
...
Start small ($1k) to test â€” scale once comfortable.

## Get Started with Aster â€” Bonus Rewards + Referral
